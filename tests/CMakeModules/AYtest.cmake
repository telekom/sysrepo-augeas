...
set(IGNORE_PATTERN "ldif")
if ("${MOD}" MATCHES "${IGNORE_PATTERN}")
    message(WARNING "The 'diff' command ignores yang-pattern.")
    execute_process(COMMAND diff -I "pattern " ${GENFILE} ${EXPFILE} RESULT_VARIABLE ret)
else()
